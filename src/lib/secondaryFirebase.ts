...
// We create a secondary app to create users without logging out the main admin
const app = getApps().find(app => app.name === 'Secondary') || initializeApp(firebaseConfig, 'Secondary');
